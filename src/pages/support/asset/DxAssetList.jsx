        ...
        <div className="layout">
          ...
          <div className="contents PDS_LIST" id="contents">
            ...
            <div className="pdslist">
              <ul>
                <li>
                  <Link to={URL.SUPPORT_ASSET_DETAIL}>
            ...
            <div className="condition xi">
              <ul>
                ...
                <li>
                  <Link to={URL.SUPPORT_ASSET_CREATE} className="btn btn_blue_h46 pd35" >
                    등록
                  </Link>
                </li>
              </ul>
            ...
            <div className="board_list BRD007">
              ...
              <div className="result">
                ...
                {/* <!-- case : 데이터 있을때 --> */}
                <Link to={URL.SUPPORT_ASSET_DETAIL} className="list_item">
                  <div>3</div>
                  <div className="al">
            ...
            {/* <div className="board_btn_area">
              ...
              <div className="right_col btn1">
                <Link to={URL.SUPPORT_ASSET_CREATE} className="btn btn_upload" >
                  <span>자료 올리기</span>
                </Link>
              </div>
            </div> */}
