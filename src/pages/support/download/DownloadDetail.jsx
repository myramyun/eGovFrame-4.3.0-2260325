      ...
      <div className="c_wrap">
        ...
        <div className="layout">
          ...
          <div className="contents PDS_VIEW" id="contents">
              ...
              <div className="info2">
                ...
                <div className="right_col">
                  ...
                  <dl>
                    <dt>파일정보</dt>
                    <dd>
                      7MB (총 1 개)/ egovframework-common-all.zip [15,083,713
                      byte]
                    </dd>
                  </dl>
                  <dl>
            ...
            <p className="pds_des">
              안녕하세요.. 공통컴포넌트 전체 소스입니다. 관련된 내용은 다음
              가이드를 참조하십시오.
              http://www.egovframe.go.kr/wiki/doku.php?id=
              egovframework:com:v3:init_guide 감사합니다.
            </p>
            ...
            <div className="bottom_navi">
              <dl>
                <dt>이전글</dt>
                <dd>
                  <Link to="">egovframe installer v1.03</Link>
                </dd>
              </dl>
              <dl>
                <dt>다음글</dt>
