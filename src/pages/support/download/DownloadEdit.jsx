...
import { default as TagLeftNav } from "@/components/leftmenu/EgovLeftNavSupport";
...
function EgovDownloadEdit(props) {
        ...
        EgovNet.requestFetch(
          ...
          (resp) => {
            if (Number(resp.resultCode) === Number(CODE.RCV_SUCCESS)) {
              alert("자료실이 추가 되었습니다.");
              navigate({ pathname: URL.SUPPORT_DOWNLOAD });
            } else {
  ...
  const initMode = () => {
    switch (props.mode) {
      case CODE.MODE_CREATE: /// 등록이면 초기값 지정 setResult
        setRole({ ...role, title: "등록", method: "POST", url: "/archive/insert", });
        setResult({ proNm: "", wrterNm: "", regDt: "", eduTarget: "", eduLimitCnt: "", eduTimeInfo: "", eduOperSysm: "", archiveCn:"", thumbImgPath: "", });
        break;

      case CODE.MODE_MODIFY: /// 수정이면 서버 요청 retrieveDetail();
        setRole({ ...role, title: "수정", method: "PUT", url: `/archive/update/${rowid}`, });
        retrieveDetail();
        break;
          ...
          <div className="contents PDS_REG" id="contents">
            ...
            <div className="board_view3">
              <div className="tit_edit">
                <dl>
                  ...
                  <dd>
                    <input className="f_input2 w_full" type="text" placeholder="" // name="progNm" title=""  id="progNm" 
              ...
              <div className="info">
                <dl> <dt>작성자</dt> <dd>{sessionUserName}</dd> </dl>
                <dl> <dt>작성일</dt> <dd>{getToday()}</dd> </dl>
              </div>

              <div className="info2">
                <div className="left_col">
                  <img src={samplePdsListImg} alt="" />
                  <p className="guide"> 썸네일 이미지는 <br /> width : 160px, height : 109px <br /> 크기의 이미지를 올려주세요 </p>
                </div>
            ...
            <div className="board_btn_area">
              <div className="left_col btn1">
                <>
                  <a href="#!" className="btn btn_skyblue_h46 w_100" onClick={() => { saveArticle(); }} > 저장 </a>
...
export default EgovDownloadEdit;