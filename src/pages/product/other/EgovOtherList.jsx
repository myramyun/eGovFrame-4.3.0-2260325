...
import { OTHER_BBS_ID } from "@/config";
...
function EgovProductList(props) {
  console.group("EgovProductList");
  console.log("[Start] EgovProductList ------------------------------");
  console.log("EgovProductList [props] : ", props);
  ...
  const retrieveList = useCallback((searchCondition) => {
    console.groupCollapsed("EgovProductList.retrieveList()");
    ...
    console.groupEnd("EgovProductList.retrieveList()");
  }, []);
  ...
  console.log("------------------------------EgovProductList [End]");
  console.groupEnd("EgovProductList");
  return (
...
export default EgovProductList;
