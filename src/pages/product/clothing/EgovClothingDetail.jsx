...
function EgovProductDetail(props) {
  console.group("EgovProductDetail");
  console.log("------------------------------");
  console.log("EgovProductDetail [props] : ", props);

  const navigate = useNavigate();
  const location = useLocation();
  console.log("EgovProductDetail [location] : ", location);
  //관리자 권한 체크때문에 추가(아래)
  const sessionUser = getSessionItem("loginUser");
  const sessionUserSe = sessionUser?.userSe;

  // 직접 URL 접근 시 location.state가 null일 수 있음
  const bbsId = location.state?.bbsId || CLOTHING_BBS_ID;
  ...
  console.groupEnd("EgovProductDetail");
...
export default EgovProductDetail;
