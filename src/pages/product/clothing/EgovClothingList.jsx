...
import { CLOTHING_BBS_ID } from "@/config";
...
function EgovClothingList(props) {
  console.group("EgovClothingList");
  console.log("[Start] EgovClothingList ------------------------------");
  console.log("EgovClothingList [props] : ", props);
  ...
  const retrieveList = useCallback((searchCondition) => {
    console.groupCollapsed("EgovClothingList.retrieveList()");
    ...
    console.groupEnd("EgovClothingList.retrieveList()");
  }, []);
  ...
  console.log("------------------------------EgovClothingList [End]");
  console.groupEnd("EgovClothingList");
  return (
...
export default EgovClothingList;
