...
function EgovProductEdit(props) {
  console.group("EgovProductEdit");
  console.log("------------------------------");
  console.log("EgovProductEdit [props] : ", props);

  const navigate = useNavigate();
  const location = useLocation();
  console.log("EgovProductEdit [location] : ", location);
  //관리자 권한 체크때문에 추가(아래)
  ...
  console.groupEnd("EgovProductEdit");
...
export default EgovProductEdit;
