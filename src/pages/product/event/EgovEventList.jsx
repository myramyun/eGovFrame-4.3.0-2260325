...
function EgovEventList(props) {
  console.group("EgovEventDetail");
  console.log("[Start] EgovEventDetail ------------------------------");
  console.log("EgovEventDetail [props] : ", props);

  const location = useLocation();
  console.log("EgovEventDetail [location] : ", location);
  ...
  const drawList = useCallback(() => {
    ...
    scheduleList.forEach(function (item, index) {
      ...
      mutListTag.push(
        <Link
          to={{ pathname: URL.PRODUCT_EVENT_DETAIL }}
          state={{
            schdulId: item.schdulId,
            prevPath: URL.PRODUCT_EVENT,
          }}
          key={listCnt}
          className="list_item"
        >
  ...
  const retrieveList = useCallback(
    (srchcnd) => {
      console.groupCollapsed("EgovEventDetail.retrieveList()");
      ...
      console.groupEnd("EgovEventDetail.retrieveList()");
    },
    [drawList]
  );
  ...
  console.log("------------------------------EgovEventDetail [End]");
  console.groupEnd("EgovEventDetail");
  return (
