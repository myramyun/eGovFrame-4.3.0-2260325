...
function EgovAdminNoticeEdit(props) {
    ...
    const intMode = () => {
      switch (props.mode) {
        case CODE.MODE_CREATE:
          setModeInfo({ ...modeInfo, modeTitle: "등록", method: "POST", editURL: "/board", });
          break;
        case CODE.MODE_MODIFY:
          setModeInfo({ ...modeInfo, modeTitle: "수정", method: "PUT", editURL: `/board/${nttId}`, });
          break;
        case CODE.MODE_REPLY:
          setModeInfo({ ...modeInfo, modeTitle: "답글쓰기", method: "POST", editURL: "/boardReply", });
          break;
        default:
  ...
  const updateBoard = () => {
    ...
    for (let key in boardDetail) { formData.append(key, boardDetail[key]); }
            ...
            <div className="board_view2">
              ...
              <div className="board_btn_area">
                <div className="left_col btn1">
                  <a href="#!" className="btn btn_skyblue_h46 w_100" onClick={() => { updateBoard(); }} >
                    저장
                  </a>
                </div>
