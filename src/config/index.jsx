...
export const EVENT_BBS_ID = "BBSMSTR_DDDDDDDDDDDD"; // 쇼핑몰 이벤트 게시판 아이디(공지사항)
export const CLOTHING_BBS_ID = "BBSMSTR_EEEEEEEEEEEE"; // 쇼핑몰 의류 게시판 아이디(갤러리)
export const OTHER_BBS_ID = "BBSMSTR_FFFFFFFFFFFF"; // 쇼핑몰 잡화 게시판 아이디(갤러리)
