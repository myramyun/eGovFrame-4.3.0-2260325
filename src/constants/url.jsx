const URL = {
  ...
  INFORM_GALLERY_DETAIL: "/egovframe-template-simple-react/inform/gallery/detail", // 알림마당/사이트갤러리상세
  INFORM_GALLERY_CREATE: "/egovframe-template-simple-react/inform/gallery/create", // 알림마당/사이트갤러리등록
  INFORM_GALLERY_MODIFY: "/egovframe-template-simple-react/inform/gallery/modify", // 알림마당/사이트갤러리수정
  INFORM_GALLERY_REPLY: "/egovframe-template-simple-react/inform/gallery/reply", // 알림마당/사이트갤러리답글

  //PRODUCT
  PRODUCT: "/egovframe-template-simple-react/product", // 쇼핑몰
  PRODUCT_EVENT: "/egovframe-template-simple-react/product/event", // 쇼핑몰/행사
  PRODUCT_EVENT_DETAIL: "/egovframe-template-simple-react/product/event/detail", // 쇼핑몰/행사/상세
  PRODUCT_CLOTHING: "/egovframe-template-simple-react/product/clothing", // 쇼핑몰/의류
  PRODUCT_CLOTHING_DETAIL: "/egovframe-template-simple-react/product/clothing/detail", // 쇼핑몰/의류/상세
  PRODUCT_CLOTHING_CREATE: "/egovframe-template-simple-react/product/clothing/create", // 쇼핑몰/의류/등록
  PRODUCT_CLOTHING_MODIFY: "/egovframe-template-simple-react/product/clothing/modify", // 쇼핑몰/의류/수정
  PRODUCT_OTHER: "/egovframe-template-simple-react/product/other", // 쇼핑몰/잡화
  PRODUCT_OTHER_DETAIL: "/egovframe-template-simple-react/product/other/detail", // 쇼핑몰/잡화/상세
  PRODUCT_OTHER_CREATE: "/egovframe-template-simple-react/product/other/create", // 쇼핑몰/잡화/등록
  PRODUCT_OTHER_MODIFY: "/egovframe-template-simple-react/product/other/modify", // 쇼핑몰/잡화/수정
  PRODUCT_EXAM: "/egovframe-template-simple-react/product/exam", // 쇼핑몰/테스트
  PRODUCT_EXAM_DETAIL: "/egovframe-template-simple-react/product/exam/detail", // 쇼핑몰//테스트/상세
  ...
  ADMIN_SCHEDULE_DETAIL: "/egovframe-template-simple-react/admin/schedule/detail", // 사이트관리/일정관리상세
